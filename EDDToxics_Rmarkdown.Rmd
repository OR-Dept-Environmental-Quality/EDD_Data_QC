...
library(kableExtra)
library(tinytex)
source("//deqlab1/VAVALOS/EDD_Data_QC-master/EDD_data_QC/ParamGrp_Function.R")


```

```{r logo, echo=FALSE,fig.align='left', out.width="400px",out.height="200px"}
knitr::include_graphics("E:/EDD_Data_QC-master/EDD_data_QC/DEQ-logo-color-notransp-horiz750x156.png")
