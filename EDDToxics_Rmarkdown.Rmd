...
if (nrow(qlc)!=0) {cat("The following table includes a list of pollutants for which the provided MRLs do not meet the recommended QLs and thus may not be sufficiently sensitive. This table uses the current established QLs that were updated in 2020. The MRL column is the value submitted by the lab as the lowest value the instrument can reliably measure. The MDL column is the value submitted by the lab as the lowest value that the instrument can detect an analyte.")}
