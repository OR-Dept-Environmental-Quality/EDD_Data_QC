...
names(mer)<-c("Sample Date","Project","Station Description","Location ID","Sample Collection Method")
...
if(nrow(methd)!=0) {kable(methd, format='latex', caption="Pollutants analyzed using non-CFR methods",booktabs=TRUE, row.names=FALSE, longtable=TRUE) %>%
                   kable_styling(latex_options=c("HOLD_position"))} else {cat("**NO KNOWN ISSUES**")}
