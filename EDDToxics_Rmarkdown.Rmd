...
## Quantitation Limits 
A quantitation limit (QL) is the lowest amount of a pollutant that can be reliably measured. Permittees are required to use the most sensitive analytical test method, as specified in 40 CFR 122.44(i)(1)(iv). Established QL requirements were adopted in 2007 for NPDES permits and updated in 2019 by DEQ WQ Permitting and Program Development. 
...
if(nrow(dff)!=0) {kable(dff, format='latex', caption="Metals with dissolved fraction larger than total recoverable fraction", booktabs=TRUE, row.names=FALSE,longtable=TRUE) %>%
  kable_styling(latex_options=c("HOLD_position","striped","scale_down","repeat_header"))} else {cat("**NO KNOWN ISSUES**")}
